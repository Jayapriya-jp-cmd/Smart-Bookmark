...
export default function SignUpPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 leading-relaxed">
            Save, organize, and sync your bookmarks effortlessly across all your devices.
          </p>
        </div>
